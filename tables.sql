...
ALTER TABLE categories ADD CONSTRAINT categorie_pk PRIMARY KEY ( codecategorie );
...
ALTER TABLE questions
    ADD CONSTRAINT questions_categorie_fk FOREIGN KEY ( codecategorie )
